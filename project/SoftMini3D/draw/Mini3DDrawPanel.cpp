...
static vertex_t mesh[] = {
	...
	{ { -10, -0,  10, 1 }, { -10, -0,  10, 1 }, { 0, 1.f }, { 1.0f, 0.2f, 0.2f }, 1 },
	{ {  10, -0,  10, 1 }, {  10, -0,  10, 1 }, { 1, 1.f }, { 0.2f, 1.0f, 0.2f }, 1 },
	{ {  10, -0, -10, 1 }, {  10, -0, -10, 1 }, { 1, 0.f }, { 0.2f, 0.2f, 1.0f }, 1 },
	{ { -10, -0, -10, 1 }, { -10, -0, -10, 1 }, { 0, 0.f }, { 1.0f, 0.2f, 1.0f }, 1 },
